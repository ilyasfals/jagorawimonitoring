        ...
        var table = $('#datatableId').DataTable({
            "aoColumns" : [
                ...
                { "sWidth": "35%" },
                {
                    ...
                    {
                        return " &nbsp&nbsp&nbsp <a href='<?php echo base_url('pengaturan/createseksi'); ?>/"+ row[3] + "' class='fa fa-pencil-square-o'> </a>"+" &nbsp <a href='<?php echo base_url('pengaturan/deleteseksi'); ?>/"+ row[3] + "' class='fa fa-trash-o'></a>";
                    }
                },
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('api/seksi');?>",
                "type": "POST"
            }
        });
